...
load('Quadcopter_UAV_horizontal_motion_and_flip.mat')
% name1 = "Quadcopter_UAV_horizontal_motion_and_flip_zoomed";
% name2 = "Quadcopter_UAV_horizontal_motion_and_flip";
name1 = "Quadcopter_UAV_horizontal_motion_and_flip_zoomed_slow";
name2 = "Quadcopter_UAV_horizontal_motion_and_flip_slow";

saveAnimation = 1.0;  %Set to 1 to save animation on AVI file.
slowDown = 1.0;
slow_factor = 5;
...
figure(2)
set(gcf, 'color', [1 1 1])
set(gcf, 'position',[100,100,1160,400])
...
for kk = 1:anim_steps
    ...
    rrTxt = sprintf('$t = %.2f$ s',tt_Vid(kk));
    rr = text(0.3, -1, rrTxt, 'Interpreter', 'latex', 'FontSize', 17);

    set(gca,'position',[0.08,0.22,0.8,0.715])
