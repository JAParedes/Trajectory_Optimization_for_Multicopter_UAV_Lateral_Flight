...
% the main program for a horizontal displacement with flip maneuver. 
%
...
for kk = 1:anim_steps
    ...
    rrTxt = sprintf('$t = %.2f$ s',tt_Vid(kk));
    if rot_dyn == 0
        rr = text(10.5, 1.25, rrTxt, 'Interpreter', 'latex', 'FontSize', 17);
    elseif rot_dyn == 1
        rr = text(10.5, 3, rrTxt, 'Interpreter', 'latex', 'FontSize', 17);
    end
